...
class Auth{
    ...
    protected $_config = array(
        ...
        'AUTH_GROUP' => 'studyfox_auth_group', //用户组数据表名
        'AUTH_GROUP_ACCESS' => 'studyfox_auth_group_access', //用户组明细表
        'AUTH_RULE' => 'studyfox_auth_rule', //权限规则表
        'AUTH_USER' => 'studyfox_user'//用户信息表
    );
